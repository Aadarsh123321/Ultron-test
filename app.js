...
$$('.nav-item').forEach(b=>b.onclick=()=>showPage(b.dataset.section));$('#practiceBtn').onclick=()=>showPage('practice');$('#exploreBtn').onclick=()=>showPage('tests');$('#brandBtn').onclick=()=>showPage('home');$('#openCBT').onclick=()=>{toast('CBT hook ready — connect your existing module.');window.dispatchEvent(new CustomEvent('open-cbt'))};
